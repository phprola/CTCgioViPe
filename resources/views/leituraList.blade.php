...
@section('conteudo')
@section('tituloPagina', 'Listagem das Leituras')
<h1>Listagem das Leituras</h1>
<form action="{{ route('leitura.search') }}" method="post">
    @csrf
    <div class="row">
        <div class="col-2">
            <select name="campo" class="form-select">
                <option value="dataLeitura">Data da Leitura</option>
                <option value="horaLeitura">Hora da Leitura</option>
                <option value="valorSensor">Valor do Sensor</option>
            </select>
        </div>
        <div class="col-4">
